...
class SpiralAutoencoder(nn.Module):
    def __init__(self, filters_enc, filters_dec, latent_size, sizes, spiral_sizes, spirals, D, U, device, activation='elu'):
        super(SpiralAutoencoder, self).__init__()
        self.encoder = SpiralEncoder(filters_enc, latent_size, sizes, spiral_sizes, spirals, D, device, activation)
        self.decoder = SpiralDecoder(filters_dec, latent_size, sizes, spiral_sizes, spirals, U, device, activation)
